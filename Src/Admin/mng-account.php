...
<nav class="navbar navbar-light bg-img">
        <div class="container-search">
            <form class="d-flex mx-auto col-md-6"id="search"  action="search.php"method="GET">
                <input  type="text"value=""name ="search" class="form-control me-2" style="margin-left:150px;width: 800px; margin-left:30px;height: 40px;"placeholder="Tìm kiếm tài khoản.." aria-label="Search">
